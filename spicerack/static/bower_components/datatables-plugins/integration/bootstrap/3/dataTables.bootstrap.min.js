		...
		b.ext.renderer.pageButton.bootstrap=function(g,f,p,k,h,l){
				...
				var j,m,n,a,k=function(a){
					...
					for(m=f.length;j<m;j++)
						if(a=f[j],c.isArray(a))
							...
							d&&(n=c("<li>",{"class":r.sPageButton+" "+e,
											"aria-controls":g.sTableId,
											tabindex:g.iTabIndex,
											id:0===p&&"string"===typeof a?g.sTableId+"_"+a:null}).append(c("<a>",{href:"#"}).html(d)).appendTo(b),
			...
			b.TableTools&&(
							c.extend(!0,b.TableTools.classes,{
															...
															collection:{container:"DTTT_dropdown dropdown-menu",
							...
							c.extend(
									!0,
									b.TableTools.DEFAULTS.oTags,
									{collection:{container:"ul",button:"li",liner:"a"}}
									)
							)
		};

	"function"===typeof define&&define.amd?define(["jquery","datatables"],f):"object"===typeof exports?f(require("jquery"),
	require("datatables")):jQuery&&f(jQuery,jQuery.fn.dataTable)
})(window,document);
